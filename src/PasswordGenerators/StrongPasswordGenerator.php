...
class StrongPasswordGenerator extends BasePasswordGenerator implements PasswordGenerator
{
    /**
     * @throws Exception
     */
    ...
    {
        return $this->generateStrengthPassword(PasswordStrength::STRONG, $length);
    }
}
